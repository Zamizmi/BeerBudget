...
import sami.beerbudget.logic.DoubleListener;
...
public class GUI extends Application {
    ...
    private Scene basicMenu() {
        ...
        buttons.add(turnDay, 0, 12);
        buttons.add(currentDate, 3, 12);
        buttons.add(shortOfTarget, 0, 15);
    ...
    private Scene moneyFlowScene() {
        ...
        submit.setOnAction((event) -> {
            ...
            if (!dateInput.getText().isEmpty()) {
                dueDate = DateLogic.stringToDate(dateInput.getText());
            }
